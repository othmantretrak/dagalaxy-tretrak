  ...
  return (
    <Layout>
      ...
      <div className="wrap privacy">
        <h1 class="entry-title">Dagalaxy&rsquo;s Privacy Policy</h1>

        <p>
          Dagalaxy (&ldquo;us&rdquo;, &ldquo;we&rdquo;, or &ldquo;our&rdquo;)
          operates https://dagalaxy.com/ (the &ldquo;Site&rdquo;). This page
        ...
        <p>
          ...
          number (&ldquo;Personal Information&rdquo;).
        </p>
        <p>
          <h3>Log Data</h3>
          <br />
          ...
          Data may include information such as your computer&rsquo;s Internet
        ...
        <p>
          ...
          web site and stored on your computer&rsquo;s hard drive.
        </p>
        <p>
        ...
        <p>
          ...
          party&rsquo;s site. We h3ly advise you to review the Privacy Policy of
          every site you visit.
        </p>
        <p>
          Dagalaxy has no control over, and assumes no responsibility for, the
        ...
        <p>
          ...
          <br />
          Dagalaxy may update this Privacy Policy from time to time. We will
